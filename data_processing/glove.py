...
def create_similarity_matrix_glove(glove_model, dictionary):
    # Initialize the WordEmbeddingSimilarityIndex with Word2Vec model
    similarity_index = WordEmbeddingSimilarityIndex(glove_model)
...
if __name__ == "__main__":   
    ...
    similarity_matrix = create_similarity_matrix_glove(glove_model, dictionary)

    similarity_matrix_path = 'data_processing/glove_similarity_matrix.pkl'
